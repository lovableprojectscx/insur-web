...
export const CategoryGrid: React.FC<CategoryGridProps> = ({ onSelectCategory }) => {
  ...
  const schools = [
    {
      ...
      icon: <HardHat className="w-5 h-5 text-[#00A3E0]" />,
      badgeColor: 'bg-[#00A3E0]',
      image: '/assets/course_residencia.jpg',
      subtitle: 'Residencia & Obras Civiles',
      description: 'Especialízate en planificación, supervisión y valorizaciones de obras.',
    ...
    },
    {
      ...
      description: 'Modelamiento hidráulico, presas de concreto y redes de saneamiento.',
    ...
    },
    {
      ...
      description: 'Cálculo estructural sismorresistente y modelado paramétrico BIM.',
    ...
    },
    {
      ...
      subtitle: 'Licitaciones & Ley Contrataciones',
      description: 'Gestión pública, arbitraje de obras y contrataciones con el Estado.',
    ...
    },
    {
      ...
      description: 'Estabilidad de taludes, geotecnia minera y seguridad SSOMA.',
  ...
  return (
    <section id="escuelas" className="py-20 lg:py-28 bg-[#FAFBFC] text-slate-900 relative overflow-hidden border-b border-slate-200 min-h-screen flex flex-col justify-center">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full mb-6">
        <div className="inline-flex items-center gap-2 bg-[#0A2540] text-white px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest border border-slate-700">
          ...
          <span>SLIDE 02 / 05 • NUESTRAS ESCUELAS DE ESPECIALIZACIÓN</span>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10">
          ...
          <p className="text-xs sm:text-sm font-bold text-slate-400 mt-1 uppercase tracking-widest">
            ESPECIALÍZATE CON DOCENTES COLEGIADOS
          </p>
        </div>

        {/* Dynamic Accordion Slide Gallery (Desktop) */}
        <div className="hidden lg:grid grid-cols-12 gap-6 items-stretch min-h-[480px]">
          
          {/* Left: 5 Expandable Interactive Cards */}
          <div className="col-span-8 flex flex-row gap-3 items-stretch">
            {schools.map((school) => {
              ...
              return (
                <motion.div
                  ...
                  className={`relative rounded-3xl overflow-hidden shadow-lg border-2 cursor-pointer transition-all duration-500 flex flex-col justify-between p-5 text-white ${
                    isSelected
                      ? 'flex-[3.5] border-[#00A3E0] shadow-2xl bg-slate-950'
                      : 'flex-1 border-slate-200 bg-slate-900 opacity-85 hover:opacity-100 hover:border-[#00A3E0]/50'
                  }`}
                >
                  <img
                    src={school.image}
                      ...
                      {isSelected && (
                        ...
                        >
                          ...
                          <button
                            ...
                            className="px-4 py-2 rounded-xl bg-[#00A3E0] hover:bg-[#0082B3] text-slate-950 font-black text-xs uppercase tracking-wider shadow-lg inline-flex items-center gap-2 cursor-pointer active:scale-95"
                          >
          ...
          {/* Right: Clean, Spacious Faculty Card */}
          <motion.div
          ...
          >
            <div>
              ...
              <div className="text-center space-y-1">
                ...
                <p className="text-xs font-black text-[#00A3E0]">
            ...
            <button
              ...
              className="mt-4 w-full py-3.5 px-4 rounded-2xl bg-[#0A2540] hover:bg-[#00A3E0] hover:text-slate-950 text-white font-black text-xs uppercase tracking-wider shadow-md flex items-center justify-center gap-2 cursor-pointer active:scale-95 transition-all"
            >
        ...
        <div className="block lg:hidden space-y-4">
          ...
          <motion.div
            ...
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: 1, y: 0 }}
            className="rounded-3xl overflow-hidden shadow-xl border-2 border-[#00A3E0] bg-white text-slate-900"
          >
            ...
            <div className="p-5 space-y-3">
              <div className="flex items-center gap-3 bg-slate-50 p-2.5 rounded-2xl border border-slate-200">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#00A3E0] font-bold">{currentSchool.instructorRole}</p>
                </div>
              </div>

              <button
                onClick={() => onSelectCategory(currentSchool.id)}
                className="w-full mt-2 py-3 px-4 rounded-xl bg-[#00A3E0] text-slate-950 font-black text-xs uppercase tracking-wider shadow-md flex items-center justify-center gap-2"
              >
