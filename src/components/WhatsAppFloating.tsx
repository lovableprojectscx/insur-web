...
export const WhatsAppFloating: React.FC = () => {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-40 flex items-center gap-2 px-3.5 py-2.5 rounded-full bg-emerald-600 hover:bg-emerald-500 text-white font-medium text-xs shadow-lg transition-all active:scale-95 cursor-pointer"
