    ...
    <section id="catalogo" className="py-20 lg:py-28 bg-slate-50 text-slate-900 relative border-b border-slate-200 min-h-screen flex flex-col justify-center">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full mb-6">
        <div className="inline-flex items-center gap-2 bg-[#0A2540] text-white px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest border border-slate-700">
          ...
          <span>SLIDE 04 / 05 • PROGRAMAS & DIPLOMADOS DESTACADOS</span>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        >
          ...
          <p className="text-xs sm:text-sm text-slate-500 mt-2 font-medium">
            Clases virtuales en vivo, campus 24/7 y certificación oficial verificable con código QR.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="max-w-xl mx-auto relative">
            ...
            <input
              type="text"
              placeholder="Buscar curso (ej. Residencia, BIM, SAP2000, Topografía)..."
              value={searchQuery}
            ...
            {filteredCourses.map((course, index) => (
              ...
              >
                ...
                <div className="p-5 bg-slate-50 border-t border-slate-200 space-y-3">
                  ...
                  <button
                    onClick={onOpenForm}
                    className="w-full py-3 rounded-xl bg-[#0A2540] hover:bg-[#00A3E0] hover:text-slate-950 text-white font-black text-xs uppercase tracking-wider shadow-md transition-all flex items-center justify-center gap-2 cursor-pointer active:scale-95"
                  >
            ...
            >
              ...
              <div className="p-5 bg-slate-50 border-t border-slate-200 flex items-center justify-between gap-3">
                ...
                <button
                  ...
                  className="px-5 py-2.5 rounded-xl bg-[#00A3E0] hover:bg-[#0082B3] text-slate-950 font-black text-xs flex items-center gap-1.5 uppercase shadow-md"
                >
                  <span>Inscribirme con 10% OFF</span>
                  <ArrowRight className="w-3.5 h-3.5" />
                </button>
